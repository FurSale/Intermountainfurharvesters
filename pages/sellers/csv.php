	...
	<?php
                              ...
                              while ($itemData=mysqli_fetch_array($result2)) {
								...
								<?php
									...
									<?php echo $seller['first_name'] ." ". $seller['last_name'] . ", ".$seller['address_1'] . " " . $seller['address_2'] . ", " . $seller['city'] . " " . $seller['state'] . " " . $seller['zip'] . "," . "$" . number_format($subtotal - (($seller['commission']/100)* $subtotal), 2, '.', '') . "\r\n"; ?>
