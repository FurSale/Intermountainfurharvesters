...
<section id="content">
	...
	<div class="container">
        ...
        <style>.rob{cursor: url(../../images/rob.png), auto;}</style>
				...
				<a class="white-text" href="edit_sellers.php?id=<?php echo $seller['id']; ?>">
					<div class="row section card-panel">
							...
							<div class="col s3 offset-s4 printhide">
								...
								<a class="rob waves-effect waves-light  btn-small blue modal-trigger" href="#modal<?php echo $seller['id']; ?>"><i class="material-icons">receipt</i></a>
