...
<ul id="dropdown3" class="dropdown-content">
  ...
  <li><a href="../../pages/buyers/list_buyers.php">Buyers</a></li>
  <li><a href="../../pages/items/list_items.php">Items</a></li>
</ul>--><ul id="dropdown1" class="dropdown-content">
  <li><a href="../../pages/items/list_items.php">All Items</a></li>
...
<ul class="right hide-on-med-and-down">
  ...
  <li><a href="../../pages/buyers/list_buyers.php" >Buyers</a></li>
  <li><a class="dropdown-trigger" href="#!" data-target="dropdown1" >Item Lists</a></li>
  <li><a href="../../pages/sellers/csv.php" >CSV</a></li>
  <li><a href="/pages/site_settings.php" d><i class="material-icons">settings_applications</i></a></li>
</ul>
</div>
...
<span class="nav-title"><?php echo $pgsettings['title']; ?></span>
  <div class="fab">
    ...
    <ul>
      <li><a href="../../pages/sellers/edit_sellers.php?new" class="btn-floating halfwayfab red tooltipped" data-position="bottom" data-tooltip="Sellers"><i class="material-icons">person_add</i></a></li>
